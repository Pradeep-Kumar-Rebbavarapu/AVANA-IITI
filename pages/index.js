            ...
            <div className="fh5co-hero">
                ...
                >
                    <div className="desc animate-box ">
                        <span>
                            <a className="btn mt-10 btn-primary btn-lg">
                                <strong>AVANA IITI</strong>
                            </a>
                        </span>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-12 text-center heading-section">
                            <h3>About Us</h3>
                            <p>
                                Avana, a Sanskrit word meaning
                                favour/protection, is a compassionate social
                                welfare club dedicated to uplifting the lives of
                                underprivileged individuals. Founded on the
                                principles of empathy and solidarity, we strive
                                to create a more equitable society where
                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <div className="feature-text">
                                <h3>Goal</h3>
                                <p>
                                    Our primary objective at Avana is to lower
                                    poverty and promote social justice by
                                    providing vital support and resources to
                                    those in need. Through various programs and
                                    initiatives, we aim to empower people to
                                    overcome socio-economic barriers and achieve
                                    self-sufficiency.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="col-md-4">
                            <div className="feature-text">
                                <h3>Main events</h3>
                                <p>
                                    Through these concerted efforts, Avana
                                    endeavours to catalyse positive change and
                                    make a tangible difference in the lives of
                                    those we serve, striving towards a more
                                    compassionate, equitable, and inclusive
                                    society for all.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-6 col-md-offset-3 text-center heading-section animate-box">
                            <h3>Our Gallery</h3>
                            <p>
                                Every beautiful memory shall be lost to time
                                unless captured in the right moment. Here are a
                                few of those moments which we shall always
